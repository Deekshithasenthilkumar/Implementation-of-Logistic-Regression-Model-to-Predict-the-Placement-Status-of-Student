...
## Algorithm
1. Load the dataset and perform one-hpt encoding on categorical features.
2. Divide the features set (X) and target (Y) into training and testing subsets.
3. Initialize the Logistic Regression mdel and fit it in the training data.
4. Generate a sigmoid curve for a single feature to demonstrate the probability threshold.
...
<img width="621" height="404" alt="image" src="https://github.com/user-attachments/assets/f489594d-4015-467c-a5ea-91c79df5a8c9" />
